...
public class IllegalCodeException extends EvaluationException {
	...
	public IllegalCodeException(String arg0, int lineNumber) {
		super(arg0, lineNumber);
	}

	public IllegalCodeException(int lineNumber, Throwable arg0) {
		super(lineNumber, arg0);
	}

	public IllegalCodeException(String arg0, int lineNumber, Throwable arg1) {
