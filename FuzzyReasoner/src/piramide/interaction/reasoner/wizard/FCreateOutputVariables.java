...
public class FCreateOutputVariables extends JFrame implements ActionListener, IFCreateVariable{
	 ...
	 */
	public FCreateOutputVariables(HashMap<String, Variable> inputVariables) {
		super();
		initialize();
	...
	private void initialize() {
		...
		this.setTitle("Create output variables");
	}
	...
	//		fCreateFile.setVisible(true);
			FCreateRules fCreateRules = new FCreateRules(this.inputVariables, this.outputVariables);
			fCreateRules.setVisible(true);
			this.dispose();
